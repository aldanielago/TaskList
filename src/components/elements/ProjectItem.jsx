...
export function ProjectItem ({ project }) {
  ...
  return (
    <div className={`${projectsPalette[project.paletteId].primaryColor} max-w-lg md:max-w-[400px] min-w-[200px] p-3 pl-5 mt-2 w-11/12 rounded-3xl flex justify-between items-center shadow-md md:flex-col md:items-start md:rounded-lg`}>
      ...
      <div className='flex w-3/5 justify-end items-center gap-2 md:w-full'>
        <span style={{ width: progressBarWidth }} className={`${projectsPalette[project.paletteId].secondaryColor} h-2 rounded-lg transition-all duration-150 ease-in-out`} />

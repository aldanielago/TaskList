...
export function ProjectItem({ project }) {
  ...
  return (
    <div className={`${projectsPalette[project.paletteId].primaryColor} max-w-lg min-w-[200px] p-3 pl-5 mt-2 w-11/12 rounded-3xl flex justify-between items-center shadow-md md:flex-col md:items-start md:rounded-lg`}>
